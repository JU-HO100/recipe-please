	...
	<table style="width: 100%;">
		<tr>
			...
			<td style="width: 12%;  padding-top: 32px; text-align: right;">
				<p style="font-family: Black Han Sans, sans-serif; color: black;"><%=rmap.get("M_NICK") %>님 환영합니다</p>
			</td>
			...
			<td style="width: 8%; padding-top: 15px; padding-left:5px; text-align: left; ">
				<a href="/member/index.jsp" style="font-family: Black Han Sans, sans-serif; color: black;">
					로그아웃
				</a>
			</td>
		</tr>
