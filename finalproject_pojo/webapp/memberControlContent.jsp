	...
	<tr>
		<td style="width: 23%; vertical-align: top;">
			<div class="btn-group-vertical" style="width: 100%;">
				 <button type="button" class="btn btn-outline-dark active" style="text-align: left;" onclick="#">회원 관리</button>
				 <button type="button" class="btn btn-outline-dark" style="text-align: left;" onclick="blackList()">블랙 리스트</button>
			</div>
		</td>
		<td style="width: 77%; padding-left: 5%; padding-right: 5%;">
						<table class="easyui-datagrid" title="회원관리"
